...
public class Cookie implements HttpHandler {
    ...
    public void handle(HttpExchange httpExchange) throws IOException {
        ...
        Headers cookieStryy = httpExchange.getRequestHeaders();
        System.out.println(cookieStryy.values());
        ...
        String cookieStr2 = httpExchange.getRequestHeaders().getFirst("Set-Cookie");
        System.out.println(cookieStr2);
        System.out.println(cookieStr);
